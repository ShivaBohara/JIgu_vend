// seed.js
// RUN THIS to copy your productdata.js products into the database.
// Usage:  node seed.js
//
// ⚠️ Keep this in sync with js/productdata.js — this is a SEPARATE COPY,
// since the live site still reads productdata.js directly for now
// (frontend hasn't been switched to fetch from the backend yet).
// Whenever you update productdata.js, copy the same changes here and re-run.
...
const machineProducts = {
  ...
  vm003: [
    ...
    // TODO: add slots 4-30 the same way once you send me the vm003 folder
  ],
};
...
async function seedDatabase() {
  ...
  console.log(Object.keys(machineProducts));
